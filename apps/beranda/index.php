...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <!-- Info Aplikasi -->
            <p>Selamat Datang di Aplikasi Absensi dan Kegiatan Harian Mahasiswa berbasis Web. Sebuah sistem yang memungkinkan para Mahasiswa Magang di <?php echo $row['nama_instansi'];?> untuk melalukan absensi dan mencatat kegiatan harian dari website. Sistem ini diharapkan dapat memberi kemudahan setiap Mahasiswa Magang untuk melakukan absensi dan mencatat kegiatan harian.</p>
            <!-- Info Aplikasi -->
