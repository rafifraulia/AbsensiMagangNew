            ...
            <div class="panel-body">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Selfie</th> <!-- Kolom untuk gambar selfie -->
                    </tr>
                </thead>
                        ...
                        <?php
                            ...
                            while ($data = mysqli_fetch_array($hasil)):
                                $no++;
                                // Path selfie, pastikan format nama file sesuai dengan struktur yang Anda gunakan
                                $path_selfie = 'uploads/selfies/selfie_' . $data['id_mahasiswa'] . '_' . $data['tanggal'] . '.png';
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if (file_exists($path_selfie)): ?>
                                            <img src="<?php echo $path_selfie; ?>" alt="Selfie" width="50" height="50">
                                        <?php else: ?>
                                            <p>Tidak Ada</p>
                                        <?php endif; ?>
                                    </td>
