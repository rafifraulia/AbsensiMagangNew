...
<?php
    ...
    $query_absen = "SELECT COUNT(*) AS jumlah_absen FROM tbl_absensi WHERE tanggal = '$tanggal_sekarang' AND id_mahasiswa = '$id_mahasiswa'";
    $result_absen = mysqli_query($kon, $query_absen);
    $data_absen = mysqli_fetch_assoc($result_absen);
    
    // Menonaktifkan tombol jika sudah absen
    if ($data_absen['jumlah_absen'] > 0) {
        ...
        <div class="panel panel-default">
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <tr>
                        <td>
                            <button id_mahasiswa="<?php echo $id_mahasiswa; ?>" id="tombol_absensi" class="tombol_periode mulai_absensi btn btn-success btn-circle"<?php echo $absensi_sudah; ?>><i class="fa fa-clock-o"></i>  Absensi</button>
                        </td>
                    </tr>
                    </tbody>
                    </table>
